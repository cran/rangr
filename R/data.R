...
#'
#' @description
#' [`SpatRaster`][terra::SpatRaster-class] object that can be used a carrying
#' capacity map to [`initialise`] data necessary to perform a simulation
...
#'
#' @description
#' [`SpatRaster`][terra::SpatRaster-class] object that can be used as a
#' carrying capacity map to [`initialise`] data necessary
#' to perform a simulation with the [`sim`] function. This map is compatible
#' with [`n1_big.tif`].
#'
...
#'
#' @description
#' [`SpatRaster`][terra::SpatRaster-class] object that can be used a
#' as simulation starting point to [`initialise`] data necessary
#' to perform a simulation with the [`sim`] function. This map is compatible
#' with [`K_small.tif`] and [`K_small_changing.tif`] maps.
#'
#' @format [`SpatRaster`][terra::SpatRaster-class] object with 15 rows
...
#' to perform a simulation with the [`sim`] function. It is compatible with the `n1_small_lon_lat.tif` raster.
#'
...
#' data necessary to perform a simulation with the [`sim`] function. To utilise
#' these maps in [`initialise`] the user must first use [`K_get_interpolation`]
...
#'This map can be used as a carrying capacity map to [`initialise`] data necessary
#' to perform a simulation with the [`sim`] function. It is compatible with the `n1_big_lon_lat.tif` raster.
#'
...
#' to [`initialise`] data necessary to perform a simulation with the [`sim`]
...
#' to [`initialise`] data necessary to perform a simulation with the [`sim`]
#' function. It is compatible with the `K_big_lon_lat.tif` map.
#'
#' @format [`SpatRaster`][terra::SpatRaster-class] object with 74 rows
...
#' [`get_observations`]  when `type` argument is set to "from_file".
#' This data is compatible with [`n1_small.tif`],
#'  [`K_small.tif`] and [`K_small_changing.tif`] maps.
#'
#' @format A data frame with 1500 rows and 3 variables:
#' \describe{
#'   \item{x}{x coordinate}
#'   \item{y}{y coordinate}
#'   \item{time_step}{time_step at which the abundances should be observed}
#' }
#'
#' @source Data generated in-house to serve as an example
#'
